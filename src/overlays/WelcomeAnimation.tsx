...
export default function WelcomeAnimation() {
  ...
  return (
    <div
      onClick={dismissWelcomeAnimation}
      style={{
        position: 'fixed',
        inset: 0,
        zIndex: 500,
    ...
    >
      <div style={{
        ...
        <h2 style={{ margin: '0 0 10px', fontSize: 24, fontWeight: 900, color: '#fff', letterSpacing: '-.5px' }}>{M.overlays.welcomeTitle(nickname)}</h2>
        <p style={{ margin: '0 0 40px', fontSize: 14, color: 'rgba(255,255,255,0.5)', fontWeight: 300, letterSpacing: '.02em' }}>{M.overlays.welcomeSubtitle}</p>
