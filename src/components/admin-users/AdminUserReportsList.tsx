...
import { getColor } from './adminUsersUtils'
import { useMessages } from '../../i18n'

type AdminReport = ReturnType<typeof useAppStore.getState>['adminReports'][number]
      ...
      {reports.map((r) => (
        <div key={r.id} style={{ padding: '14px 20px', borderBottom: '1px solid #F5F5F5' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 10 }}>
            ...
            <div style={{ flex: 1 }}>
              <p style={{ margin: '0 0 2px', fontSize: 12, fontWeight: 700, color: '#111111' }}>{M.adminUsers.reportedUser(r.user, r.count)}</p>
